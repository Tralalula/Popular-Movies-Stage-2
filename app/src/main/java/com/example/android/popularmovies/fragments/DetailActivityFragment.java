...
import com.example.android.popularmovies.tmdb.Reviews;
import com.example.android.popularmovies.tmdb.TmdbInterface;
import com.example.android.popularmovies.tmdb.TmdbService;
import com.example.android.popularmovies.tmdb.Trailers;
...
public class DetailActivityFragment extends Fragment {
    ...
    @Bind(R.id.overview_title) TextView mOverviewTitle;
    @Bind(R.id.trailers_title) TextView mTrailersTitle;
    @Bind(R.id.reviews_title) TextView mReviewsTitle;
    ...
    @Bind(R.id.trailers) LinearLayout mTrailersLinearLayout;
    @Bind(R.id.reviews) LinearLayout mReviewsLinearLayout;
